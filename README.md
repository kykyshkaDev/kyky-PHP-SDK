...
kyky_token не является постоянным идентификатором, отслеживать по нему пользователя в разных опросах невозможно. Он предназначен именно для пометки конкретной заявки/лида, а не пользователя.<br>
